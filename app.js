...
const ICONS = {
  ...
  'step-sip': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><polyline points="4 20 4 14 8 14 8 9 12 9 12 5 16 5 16 2 20 2 20 20"/><line x1="4" y1="20" x2="20" y2="20"/></svg>`,
  lumpsum: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 16V9"/><path d="M9 12l3-3 3 3"/></svg>`,
  swp: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M17 2.1l4 4-4 4"/><path d="M3 12.2v-2a4 4 0 0 1 4-4h14"/><path d="M7 21.9l-4-4 4-4"/><path d="M21 11.8v2a4 4 0 0 1-4 4H3"/></svg>`,
  'sip-vs-lumpsum': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="10" width="7" height="10" rx="1"/><rect x="14" y="5" width="7" height="15" rx="1"/><line x1="1" y1="21" x2="23" y2="21"/></svg>`,
